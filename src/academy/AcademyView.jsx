...
export default function AcademyView({ courseSlug, lessonSlug, onOpenCourse, onBack, history, historySyncEnabled, onLessonHistory, onDeleteHistory, onAddJournal }) {
  ...
  if (course) return <CourseOverview course={course} history={history} historySyncEnabled={historySyncEnabled} onBack={onBack} onOpenLesson={(nextLessonSlug) => onOpenCourse(course.slug, nextLessonSlug)} onDeleteHistory={onDeleteHistory} onAddJournal={onAddJournal} />;
...
function CourseOverview({ course, history, historySyncEnabled, onBack, onOpenLesson, onDeleteHistory, onAddJournal }) {
  return (
    <section className="academy-page academy-course-page" aria-labelledby="academy-course-title">
      ...
      <AcademyHistory history={history} course={course} syncEnabled={historySyncEnabled} onDeleteHistory={onDeleteHistory} onAddJournal={onAddJournal} />
